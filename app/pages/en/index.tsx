          ...
          <div className="flex flex-wrap -m-4 font-jp font-medium">
            <div className="lg:w-1/3 lg:mb-0 mb-20">
              <div className="h-full text-center">
                ...
                <h2 className="text-white font-medium title-font tracking-wider text-2xl">{ t.member.first.name }</h2>
                {
                  locale == "ja" &&
            ...
            <div className="lg:w-1/3 lg:mb-0 mb-20">
              <div className="h-full text-center">
                ...
                <h2 className="text-white font-medium title-font tracking-wider text-2xl">{ t.member.second.name }</h2>
                {
                  locale == "ja" &&
            ...
            <div className="lg:w-1/3 lg:mb-0 mb-20">
              <div className="h-full text-center">
                ...
                <h2 className="text-white font-medium title-font tracking-wider text-2xl">{ t.member.third.name}</h2>
                {
                  locale == "ja" &&
