    ...
    <div className="text-white body-font" id="service">
      <div className="py-16 lg:py-28 px-5 md:px-24 bg-sh-gray shadow-lg">
        <div className="text-center mb-20">
          {locale == 'ja' && (
            <p className="text-lg font-jp font-bold py-2 text-transparent bg-clip-text bg-gradient-to-b from-sh-light-blue  via-sh-blue to-sh-dark-blue">
              事業概要
            </p>
          )}
        ...
        <div className="font-jp font-medium text-sh-black md:px-20 md:mb-10 lg:w-3/4 mx-auto">
          <h2 className="text-2xl md:text-3xl lg:text-4xl pt-5 font-light text-center">
            {t.service.description.title1}
          </h2>
          <h2 className="text-2xl md:text-3xl lg:text-4xl pb-5 font-light text-center">
            {t.service.description.title2}
          </h2>
          <p className="leading-relaxed text-xl mt-5 text-left lg:text-center">
            {t.service.description.content.former}
            <br />
        ...
        <div className="container mx-auto text-sh-black lg:py-20 space-y-10 lg:space-y-32">
          ...
          <div className="font-jp font-medium text-sh-black">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-light text-center">
              {t.service.example.header.title}
            </h2>
            <p className="leading-relaxed text-xl mt-5 text-left lg:text-center">
          ...
          <div className="container">
            <div className="flex flex-wrap items-top lg:px-10 xl:w-3/5 mx-auto border-b border-gray-200 flex-row">
              ...
              <div className="flex-grow text-left lg:ml-20 w-20">
                <p className="text-lg font-en font-bold text-transparent bg-clip-text bg-gradient-to-b from-sh-light-blue  via-sh-blue to-sh-dark-blue">
                  example 01
                </p>
                <h2 className="text-3xl md:text-4xl py-2">
                  {t.service.example.first.title}
                </h2>
            ...
            <div className="flex flex-wrap items-top my-10 lg:w-3/5 mx-auto border-b border-gray-200">
              <div className="flex flex-col text-center items-center md:w-1/2">
                ...
                <div className="flex-grow pl-6">
                  <h2 className="text-gray-900 font-jp text-lg title-font font-bold mb-2 text-left">
                    {t.service.example.first.content.first.title}
                  </h2>
              ...
              <div className="flex flex-col text-center items-center md:w-1/2">
                ...
                <div className="flex-grow pl-6">
                  <h2 className="text-gray-900 font-jp text-lg title-font font-bold mb-2 text-left">
                    {t.service.example.first.content.second.title}
                  </h2>
                  <p className="leading-relaxed text-base font-jp font-medium text-left">
              ...
              <div className="flex flex-wrap xl:divide-x divide-sh-gray3 py-10 justify-center">
                <div className="flex xl:w-1/2 items-center justify-center">
                  ...
                  <div className="flex flex-col items-center lg:ml-5">
                    <button
                      ...
                      className="mx-auto h-12 md:h-16 font-bold text-white bg-sh-blue hover:bg-sh-blue-hover  border-0 py-2 px-8 focus:outline-none rounded-full text-lg"
                    >
                      {t.service.contact.document.button}
                    </button>
                    <p className="text-base font-jp font-medium mt-4">
                      {t.service.contact.document.description}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex xl:w-1/2 items-center justify-center">
                  ...
                  <div className="flex flex-col items-center lg:ml-5">
                    <button
                      onClick={() => {
                        window.location.href = 'https://ai-gaikan.stathack.jp/'
                      }}
                      className="mx-auto h-12 md:h-16 font-bold text-sh-blue bg-sh-white hover:bg-sh-blue-hover border-2 border-sh-blue py-2 px-8 focus:outline-none rounded-full text-lg"
                    >
                      {t.service.contact.ai.button}
                    </button>
                    <p className="text-base font-jp font-medium mt-4">
                      {t.service.contact.ai.description}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="container">
            <div className="flex flex-wrap items-top lg:w-3/5 mx-auto border-b border-gray-200 flex-row">
              <div className="flex-grow text-left lg:w-1/2">
                ...
                <h2 className="text-3xl md:text-4xl py-2">
                  {t.service.example.second.title}
                </h2>
                <p className="leading-relaxed text-base font-jp font-medium mb-5">
            ...
            <div className="flex flex-wrap items-top my-10 lg:w-3/5 mx-auto border-b border-gray-200 flex-row">
              <div className="flex flex-col text-center items-center md:w-1/2">
                ...
                <div className="flex-grow pl-6">
                  <h2 className="text-gray-900 font-jp text-lg title-font font-bold mb-2 text-left">
                    {t.service.example.second.content.first.title}
                  </h2>
                  <p className="leading-relaxed text-base font-jp font-medium text-left">
              ...
              <div className="flex flex-col text-center items-center md:w-1/2">
                ...
                <div className="flex-grow pl-6">
                  <h2 className="text-gray-900 font-jp text-lg title-font font-bold mb-2 text-left">
                    {t.service.example.second.content.second.title}
                  </h2>
                  <p className="leading-relaxed text-base font-jp font-medium text-left">
          ...
          <div className="flex flex-wrap xl:flex-nowrap lg:w-3/4 mx-auto justify-center -my-2">
            <div className="relative my-2">
              <svg
                className="text-sh-dark-blue text-opacity-30 fill-current"
                width="190"
                height="80"
                viewBox="0 0 190 81"
              ...
              <p className="absolute top-7 left-11 text-sh-dark-blue font-bold">
                {t.service.flow.steps.first}
              </p>
            </div>
            <div className="relative my-2">
              <svg
              ...
              <p className="absolute top-7 left-14 text-sh-dark-blue font-bold">
                {t.service.flow.steps.second}
              </p>
            </div>
            <div className="relative my-2">
              <svg
            ...
            <div className="relative my-2">
              ...
              <p className="absolute top-7 left-16 text-sh-dark-blue font-bold">
                {t.service.flow.steps.fourth}
              </p>
            </div>
            <div className="relative my-2">
              <svg
          ...
          <div className="flex flex-wrap mx-auto lg:w-1/2">
            <div className="flex-col items-center w-1/2 px-4">
              ...
              >
                <path
                  d="M2.25 2.88647H6V0.636475H0V6.63647H2.25V2.88647Z"
                  fill="#0148B1"
                />
                <path
                  d="M17.9995 0.636475V2.88647H21.7495V6.63647H23.9995V0.636475H17.9995Z"
                  fill="#0148B1"
                />
                <path
                  d="M21.7495 22.3865H17.9995V24.6365H23.9995V18.6365H21.7495V22.3865Z"
                  fill="#0148B1"
                />
                <path
                  d="M2.25 18.6365H0V24.6365H6V22.3865H2.25V18.6365Z"
                  fill="#0148B1"
                />
                <path
                  d="M12 18.6365C15.3137 18.6365 18 15.9502 18 12.6365C18 9.32277 15.3137 6.63647 12 6.63647C8.68629 6.63647 6 9.32277 6 12.6365C6 15.9502 8.68629 18.6365 12 18.6365Z"
                  fill="#0148B1"
                />
              </svg>
              <h3 className="mb-4 font-bold">
                {t.service.technology.kinds.first.title}
              </h3>
            ...
            <div className="flex-col items-center w-1/2 px-4">
              ...
              >
                <g clipPath="url(#clip0_1013_10036)">
                  <path
                    d="M3.65674 4.29321V24.6365H24V4.29321H3.65674ZM22.1713 22.8078H5.48543V6.1219H22.1713V22.8078Z"
                    fill="#0148B1"
                  />
                  <path
                    d="M6.6642 19.6075H20.9925C21.1357 19.6075 21.2671 19.5289 21.3349 19.4028C21.4028 19.2772 21.396 19.1239 21.3171 19.0047L16.8708 12.268C16.6908 11.9952 16.3858 11.8313 16.0587 11.8313C15.732 11.832 15.4271 11.9963 15.2474 12.2698L12.1153 17.0363L10.3866 15.0769C10.1859 14.8498 9.89093 14.7288 9.58882 14.7506C9.28639 14.772 9.01137 14.9334 8.84534 15.1866L6.33921 19.0054C6.26065 19.125 6.25423 19.2775 6.3221 19.4033C6.38993 19.5293 6.52137 19.6075 6.6642 19.6075Z"
                    fill="#0148B1"
                  />
                  <path
                    d="M10.3153 13.2646C11.4041 13.2646 12.2865 12.3823 12.2865 11.2935C12.2865 10.2046 11.4041 9.32227 10.3153 9.32227C9.2265 9.32227 8.34375 10.2046 8.34375 11.2935C8.34375 12.3823 9.2265 13.2646 10.3153 13.2646Z"
                    fill="#0148B1"
                  />
                  <path
                    d="M20.3433 2.46521V0.636475H0V20.9798H1.82873V19.1511V2.46521H18.5146H20.3433Z"
                    fill="#0148B1"
                  />
                </g>
                <defs>
                  <clipPath id="clip0_1013_10036">
                    <rect
                      ...
                      height="24"
                      fill="white"
                      transform="translate(0 0.636475)"
                    />
                  </clipPath>
                </defs>
              </svg>
              <h3 className="mb-4 font-bold">
                {t.service.technology.kinds.second.title}
              </h3>
            ...
            <div className="flex-col items-center w-1/2 px-4 mt-10">
              ...
              <h3 className="mb-4 font-bold">
                {t.service.technology.kinds.third.title}
              </h3>
            ...
            <div className="flex-col items-center w-1/2 px-4 mt-10">
              ...
              <h3 className="mb-4 font-bold">
                {t.service.technology.kinds.fourth.title}
              </h3>
